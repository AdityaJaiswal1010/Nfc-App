...
class ExternalRecord implements Record {
  ...
  // String get typeType => type + (number.isEmpty ? '':':$number');
  String get dataString => utf8.decode(data);
  ...
  static ExternalRecord fromNdef(NdefRecord record) {
    ...
    final typeType = ascii.decode(record.type);
    // final coloIndex=typeType.lastIndexOf(':');
    ...
    return ExternalRecord(
      ...
      data: record.payload, 
      // number:coloIndex<0?'':domainType.substring(colonIndex+1),
    );
  }
